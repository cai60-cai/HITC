...
public class AesUtil {
    ...
    public String aesDecrypt(String encrypt) {
        try {
            return aesDecrypt(encrypt, commonConfig.getAesKey());
        } catch (Exception e) {
            log.error("aes解密异常：" + e);
            return "";
        }
    ...
    public String aesEncrypt(String content) {
        try {
            return aesEncrypt(content, commonConfig.getAesKey());
        } catch (Exception e) {
            log.error("aes加密异常：" + e);
            return "";
        }
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("加密密钥和解密密钥：" + str);
        AesUtil aes = new AesUtil();
        String encrypt = aes.aesEncrypt(content, str);
        System.out.println("加密后：" + encrypt);
        String decrypt = aesDecrypt(encrypt, str);
